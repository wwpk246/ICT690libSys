...
HTML Form
create an html file, mylibrary.html:
...
Text entry for the html is listed above in previous section.

-Change the IP address to match the google external:
Be sure to replace the example IP address (11.111.222.222 above) with the external IP address google vm.
